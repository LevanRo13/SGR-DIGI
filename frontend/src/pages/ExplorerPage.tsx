  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Blockchain Explorer</h1>
        <p className="text-slate-500 text-center max-w-md">
          Explore and verify on-chain transactions on Stellar Testnet. This feature will be available in HU-07.
        </p>
