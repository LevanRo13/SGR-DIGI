  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Procesos</h1>
        <p className="text-slate-500 text-center max-w-md">
          Visualizá y gestioná todos los procesos de garantía. Esta funcionalidad estará disponible en HU-13.
        </p>
